...
st.markdown("Embark on a transformative health journey with **Health Oracle**, the innovative app designed to utilize advanced scanning technology. Our cutting-edge algorithms empower you with precise identification of various health conditions, providing valuable insights for informed decision-making.")
def gradient_text(text, color1, color2):
        gradient_css = f"""
        background: -webkit-linear-gradient(left, {color1}, {color2});
        -webkit-background-clip: text;
...
Health Oracle is your ally in identifying three distinct types of brain tumors:
...
st.write(f"<div>{styled_text}</div>", unsafe_allow_html=True)
st.markdown("""
Navigate the complexities of lung health with Health Oracle, distinguishing between three primary types of lung cancer:
...
st.markdown("""
Health Oracle extends its capabilities to renal health, offering insights into three crucial conditions:
...
Embark on a journey towards personalized healthcare. Download **Health Oracle** now and unlock a new era of well-being. Your health, our priority!
"""
